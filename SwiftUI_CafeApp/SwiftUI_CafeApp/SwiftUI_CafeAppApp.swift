//  SwiftUI_CafeAppApp.swift

// 깃허브(Github.com) : 세계최대 무료소스 공유사이트
// AlertToast, SDWebImageSwiftUI 라이브러리 사용하기
// Cocoa Pod : 라이브러리(모듈) 관리 툴 - 다운로드(디펜던시), 삭제, 업데이트
